...
return {
  ...
  opts = function(_, opts)
    ...
    opts.formatters_by_ft.ps1 = { "powershell", "trim_whitespace" }
    opts.formatters_by_ft.psm1 = { "powershell", "trim_whitespace" }
    opts.formatters_by_ft.markdown = { "prettier", "trim_whitespace" }
    opts.formatters_by_ft.powershell = { "powershell", "trim_whitespace" }
